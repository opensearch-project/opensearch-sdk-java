...
public interface SearchExtension {
    /**
     * The new {@link ScoreFunction}s defined by this Extension.
     */
    ...
    /**
     * The new {@link SignificanceHeuristic}s defined by this Extension. {@linkplain SignificanceHeuristic}s are used by the
    ...
    /**
     * The new {@link MovAvgModel}s defined by this Extension. {@linkplain MovAvgModel}s are used by the {@link MovAvgPipelineAggregator} to
    ...
    /**
     * The new {@link SearchExtBuilder}s defined by this Extension.
     */
    ...
    /**
     * Get the {@link Highlighter}s defined by this Extension.
     */
    ...
    /**
     * The new {@link Suggester}s defined by this Extension.
     */
    ...
    /**
     * The new {@link Query}s defined by this Extension.
     */
    ...
    /**
     * The new {@link Sort}s defined by this Extension.
     */
    ...
    /**
     * The new {@link Aggregation}s added by this Extension.
     */
    ...
    /**
     * Allows Extensions to register new aggregations using aggregation names that are already defined
    ...
    /**
     * Allows Extensions to register new Aggregation in the {@link CompositeAggregation}.
     *
    ...
    /**
     * The new {@link PipelineAggregator}s added by this Extension.
     */
    ...
    /**
     * The new {@link Rescorer}s added by this Extension.
     */
    ...
    /**
     * The new {@link QueryPhaseSearcher} added by this Extension. At the moment, only one {@link QueryPhaseSearcher} is supported per
     * instance, the {@link IllegalStateException} is going to be thrown if more then one Extension tries to register
    ...
    class SuggesterSpec<T extends SuggestionBuilder<T>> extends SearchExtensionSpec<T, CheckedFunction<XContentParser, T, IOException>> {
         ...
         *        an error if {@link ParseField#getPreferredName()} conflicts with another registered name, including names from other Extensions.
         ...
         *        with another registered name, including names from other Extensions.
         * @param builderReader the reader registered for this suggester's builder. Typically, a reference to a constructor that takes a
         *        {@link StreamInput}
         * @param builderParser a parser that reads the suggester's builder from xcontent
         * @param suggestionReader the reader registered for this suggester's Suggestion response. Typically, a reference to a constructor
    ...
    class PipelineAggregationSpec extends SearchExtensionSpec<
         ...
         *        {@link ParseField#getPreferredName()} conflicts with another registered name, including names from other Extensions.
