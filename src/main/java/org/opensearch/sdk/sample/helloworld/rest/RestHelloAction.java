    ...
    public List<NamedRoute> routes() {
        return List.of(
            ...
            new NamedRoute.Builder().method(DELETE)
                ...
                .uniqueName(addRoutePrefix("goodbye"))
                .legacyActionNames(Collections.emptySet())
                .build()
        );
    }
