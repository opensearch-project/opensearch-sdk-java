...
public class ExtensionsRunner {
     ...
     *
     * @throws IOException
     *             if the runner failed to read settings or API.
     */
     ...
     *
     * @param extension
     *            The settings with which to start the runner.
     * @throws IOException
     *             if the runner failed to read settings or API.
     */
    ...
    InitializeExtensionsResponse handleExtensionInitRequest(InitializeExtensionsRequest extensionInitRequest) {
        ...
        try {
            ...
            // After sending successful response to initialization, send the REST API and
            // Settings
    ...
    /**
     * Handles a request from OpenSearch and invokes the extension point API
     * corresponding with the request type
     *
     * @param request
     *            The request to handle.
     * @return A response to OpenSearch for the corresponding API
     * @throws Exception
     *             if the corresponding handler for the request is not present
     */
    ...
    /**
     * Handles a request for extension point indices from OpenSearch. The
     * {@link #handleExtensionInitRequest(InitializeExtensionsRequest)} method must
     * have been called first to initialize the extension.
     *
     * @param indicesModuleRequest
     *            The request to handle.
     * @param transportService
     *            The transport service communicating with OpenSearch.
     * @return A response to OpenSearch with this extension's index and search
     *         listeners.
     */
    ...
    /**
     * Handles a request for extension name from OpenSearch. The
     * {@link #handleExtensionInitRequest(InitializeExtensionsRequest)} method must
     * have been called first to initialize the extension.
     *
     * @param indicesModuleRequest
     ...
     *
     * @param request
     *            The REST request to execute.
     * @return A response acknowledging the request.
     */
    RestExecuteOnExtensionResponse handleRestExecuteOnExtensionRequest(ExtensionRestRequest request) {
     ...
     *
     * @param transportService
     *            The TransportService defining the connection to OpenSearch.
     */
     ...
     *            The exception to be sent to OpenSearch
     */
     ...
     *            The component setting that correspond to the values provided by
     ...
     * @param transportService
     *            The TransportService defining the connection to OpenSearch.
     * @param settingUpdateConsumers
     *            A map of setting objects and their corresponding consumers
     * @throws Exception
     *             if there are no setting update consumers within the
     *             settingUpdateConsumers map
     */
     ...
     *
     * @param timeout
     *            The timeout for the listener in milliseconds. A timeout of 0 means
     *            no timeout.
     */
     ...
     *            Unused
     * @throws IOException
     *             if the runner failed to connect to the OpenSearch cluster.
     */
